CREATE DATABASE  IF NOT EXISTS `onlineshopping_sukanya` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `onlineshopping_sukanya`;
-- MySQL dump 10.13  Distrib 8.0.12, for macos10.13 (x86_64)
--
-- Host: localhost    Database: onlineshopping_sukanya
-- ------------------------------------------------------
...
INSERT INTO `addproduct` VALUES (1,'macbook pro',1200.99,0,12,'gray,white,black,pink','In that case, the MacBook Pro is most certainly worth it because it may be the only laptop that can do the job. Plus, the MacBook Pro can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 19:48:55',2,1,'492392c9a1d80c65f3c3.jpg','68e0b733e736307b0cba.jpeg','870b6e7fe62f69b1b811.jpeg','laptop'),(2,'iphone x',1150.99,0,20,'gray,white,black','In that case, the MacBook Pro is most certainly worth it because it may be the only laptop that can do the job. Plus, the MacBook Pro can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:09:15',1,1,'1b6b45a578914ed1fde8.jpg','f7a5a4ca49273d1ca481.jpeg','adf5364b9edb107fcc91.jpg','phone'),(3,'imac',1950.99,10,20,'gray,white,black','In that case, the MacBook Pro is most certainly worth it because it may be the only laptop that can do the job. Plus, the MacBook Pro can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:10:20',3,1,'fcd9f839069f478205ca.jpeg','c3434dc04ae9b08a1a62.jpg','f0f100021cc040042e55.jpg','laptop'),(4,'sony laptop',880.50,15,20,'gray,white,black','In that case, the Sony is most certainly worth it because it may be the only laptop that can do the job. Plus, the Sony  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:11:43',2,2,'1a8f02a703d918008306.jpg','64ee0289b5a406f5bcf9.jpg','1bb91dfc4629c7adcd2c.jpg','laptop'),(5,'sony tv',980.50,0,20,'pink,gray,white,black,blue','In that case, the Sony is most certainly worth it because it may be the only laptop that can do the job. Plus, the Sony  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:14:20',4,2,'87fcab43cab157ab14b7.jpg','34942c9898c611980859.jpg','02448be8f85e3555bbd3.jpeg','tv'),(6,'sony mobile',780.50,10,20,'blue,gray,white,black','In that case, the Sony is most certainly worth it because it may be the only laptop that can do the job. Plus, the Sony  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:15:54',1,2,'040f3c7cb7d97ac64e6e.jpeg','24929353ddc0bafa0446.jpg','33db0031a633112aee3a.jpeg','phone'),(7,'HP',780.50,5,20,'blue,gray,white,black','In that case, the HP is most certainly worth it because it may be the only laptop that can do the job. Plus, the PH  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:18:25',2,4,'fb152ad7428856fb1a92.jpg','f30553a2120ecde23684.jpeg','397833603b0ea0762805.jpg','laptop'),(8,'Dell',780.50,5,20,'blue,gray,white,black','In that case, the HP is most certainly worth it because it may be the only laptop that can do the job. Plus, the PH  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:19:50',2,3,'c8cd10e2fd79892fd1f1.jpeg','7b3f6dcc218945581199.jpg','16cfef10d24fe04f54ac.jpeg','lapop'),(9,'Samsang mobile',780.50,15,25,'blue,gray,white,black','In that case, the Samsang is most certainly worth it because it may be the only laptop that can do the job. Plus, the Samsang  can also be configured to boot Windows if that is needed for certain software available only on Windows','2020-02-16 20:21:55',1,6,'b93a85f9a61f2a7856d8.png','36506d32d97d01c298a1.jpeg','b691bc6172599269eed1.jpg','mobile'),(10,'Rado watch',1200.99,0,25,'golden,white,black','Millions of people around the world have - and continue to - improve their lives based on the teachings of Dale Carnegie. In \"How to Win Friends and Influence People\", Carnegie offers practical advice and techniques, in his exuberant and conversational style, for how to get out of a mental rut and make life more rewarding. His advice has stood the test of time and will teach you how to: make friends quickly and easily; increase your popularity','2020-02-17 18:21:24',7,5,'b85904527fd0cea93c90.jpeg','c1c37e487199c78c64d3.jpg','ee42709e4fe53e241762.jpeg','watch'),(11,'Canon camera ',560.89,0,25,'gray,white,black','Millions of people around the world have - and continue to - improve their lives based on the teachings of Dale Carnegie. In \"How to Win Friends and Influence People\", Carnegie offers practical advice and techniques, in his exuberant and conversational style, for how to get out of a mental rut and make life more rewarding. His advice has stood the test of time and will teach you how to: make friends quickly and easily; increase your popularity','2020-02-17 18:22:57',6,7,'dc900c380baf7d227ef0.png','21b85a9bc4f7b8ef21fc.jpeg','3e2be726a5b063a2cfe1.jpeg','camera'),(12,'Apple watch',450.89,10,8,'blue,gray,white,black','Millions of people around the world have - and continue to - improve their lives based on the teachings of Dale Carnegie. In \"How to Win Friends and Influence People\", Carnegie offers practical advice and techniques, in his exuberant and conversational style, for how to get out of a mental rut and make life more rewarding. His advice has stood the test of time and will teach you how to: make friends quickly and easily; increase your popularity','2020-02-17 18:29:29',7,1,'09f788f8cb89c480faa7.png','87bf0baeab6af4239466.jpg','62f2f68db7286cbbd58a.jpeg','watch'),(13,'Galaxy',400.00,10,20,'red','Sony Galaxy cheap good fast','2021-02-20 19:20:01',3,2,'21d278cd3fcbd593c7df.jpeg','fabaf16b5eb8f789c4b3.jpeg','907de7caf1b8f84d8e69.jpeg','phone');
...
INSERT INTO `brand` VALUES (1,'Apple'),(7,'Canon'),(3,'Dell'),(4,'HP'),(5,'Rado'),(6,'samsung'),(2,'Sony');
...
INSERT INTO `category` VALUES (6,'Camera'),(3,'Desktop'),(5,'Ipad'),(2,'Laptop'),(1,'Mobile'),(4,'TV'),(7,'Watch');
...
INSERT INTO `seller_products` VALUES (1,'Dipa Saha','dipa.saha5922@gmail.com','watch tv phone'),(2,'Manisha Saha','manishasaha504@gmail.com','watch tv phone'),(3,'Sukanya Saha','sukanyasaha003@gmail.com','watch tv phone');
...
INSERT INTO `sold_products` VALUES (1,'Sukanya Saha','sukanyasaha007@gmail.com','Galaxy M1',13,10),(1360,'Namratha Mysore Keshavaprakash','nmk002@gmail.com','Ferrari',1,100);
...
-- Dump completed on 2021-03-04 12:21:59
CREATE DATABASE  IF NOT EXISTS `onlineshopping` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `onlineshopping`;
-- MySQL dump 10.13  Distrib 8.0.12, for macos10.13 (x86_64)
--
